...
def _label_propagation(args):
    ...
    needed_args = set(["model_type", "save_path", "temperature", "topk", "radius", "video_len", "filelist", 
                       "crop_size", "config_file", "output_dir", "pretrained_weights", "opts"])
...
def main(args):
    ...
    davis_prop_args = {
        ...
        "save_path": f"{args.downstream_output_dir}/davis/in/",
    ...
    conversion_davis_args = {
        "out_folder": f"{args.downstream_output_dir}/davis/out/",
        "in_folder": f"{args.downstream_output_dir}/davis/in/",
    ...
    evaluation_davis_args = {
        ...
        "results_path": f"{args.downstream_output_dir}/davis/out/"
    }

    jhmdb_prop_args = {
        "model_type": model_type,
        "save_path": f"{args.downstream_output_dir}/jhmdb/",
    ...
    evaluation_jhmdb_args = {
        "filelist": args.jhmdb_file,
        "src_folder": f"{args.downstream_output_dir}/jhmdb/",
        "feat_res": args.jhmdb_feat_res
    }

    vip_prop_args = {
        "model_type": model_type,
        "save_path": f"{args.downstream_output_dir}/vip/",
    ...
    evaluation_vip_args = {
        ...
        "pre_dir": f"{args.downstream_output_dir}/vip/"
    }
    ...
    wandb.init(
        ...
        config = {
            "downstream_output_dir": args.downstream_output_dir,
            "params" : {
...
if __name__ == "__main__":
    description = "Downstream tasks evaluation"
    # Arguments
