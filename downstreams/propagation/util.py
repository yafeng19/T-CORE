...
def get_args_parser():
    ...
    # General arguments
    parser.add_argument('--downstream_output_dir', default='downstreams/propagation/cropmae_eval', type=str, help='Output directory')
    ...
    parser.add_argument("--output_dir", default="", type=str, help="Output directory to save logs and checkpoints",)
